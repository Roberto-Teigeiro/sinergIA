...
export default function Sidebar(){
    ...
    const token = getToken({template:'supabase'}).then(()=>{console.log(token)})
...
return(
    ...
    >
        ...
        <small className="text-center text-xs font-medium">Tasks</small>
    </a>
    ...
    >
        ...
        <small className="text-center text-xs font-medium"> Team </small>
    </a>
