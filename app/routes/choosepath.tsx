...
const choosepath = () => {
  ...
  return (
    <div className="h-screen bg-gray-50">
      ...
      {showProjectModal &&
      <div 
      className="fixed bg-slate-500 bg-opacity-80 h-full fixed inset-0 overflow-hid z-50"> 
      <NewProjectModal/>
      <button 
        onClick= {toggleCreateModal} 
        className="bg-white rounded-md p-2 inline-flex items-center justify-center text-black hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 top-16 right-16 absolute text-white">
