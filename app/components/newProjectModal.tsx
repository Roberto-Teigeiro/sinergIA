          ...
          <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
            <div className="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  id="phone"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                  placeholder="Detail any infrastructure available for use in this project"
                  required
                />
              </div>
              <div>
                <label
                  ...
                  className="block mb-2 text-sm font-medium text-gray-900"
                >
                  Required Departments (use commas)
                </label>
                <input
                  name="requireddepartments"
                  type="text"
                  id="company"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              ...
              <div>
                <label
                  ...
                  className="block mb-2 text-sm font-medium text-gray-900"
                >
                  Required users (per department)
                </label>
                <input
                  name="requireduserdepartment"
                  type="number"
                  id="visitors"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                  placeholder="1"
            ...
            <div className="mb-6">
              ...
              <input
                ...
                id="objective"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="What are the specific goals or outcomes you aim to achieve with this project?"
                required
              />
            </div>
