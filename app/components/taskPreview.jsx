...
const TaskPreview = ({ cardTitle, description, date }) => {
  ...
  return (
                ...
                <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-2 text-gray-700 dark:text-gray-300">{date}</p>
                            <button className="py-2 px-4 bg-gray-200 text-gray-800 font-semibold rounded-lg shadow-md hover:bg-gray-300 focus:outline-none focus:bg-gray-300">Completed</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    className= "flex justify-center space-x-4">
        <TaskModal cardTitle="Task to do" description="Descripción task" date="due date" />
    </div>
